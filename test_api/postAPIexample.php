...
<body>
    <div class="container mt-5">
        ...
        <!-- Add Class Form Example -->
        <div class="card mb-4">
            <div class="card-header">
                <h5>Add New Class Example</h5>
            </div>
            <div class="card-body">
                <form id="addClassForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="section" required>
                    </div>
                    <div class="mb-3">
    ...
    <?php include("modals/postexamplemodal.php")?>
    ...
    <script>
        $(document).ready(function() {
            $('#addClassForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'http://localhost/PhpAPI/api.php?request=addClass&token='+token,
                    method: 'POST',
                    data: {
