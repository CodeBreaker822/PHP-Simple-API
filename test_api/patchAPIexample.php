...
<head>
    ...
    <title>PATCH API Examples</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container mt-5">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5>Update Class Example (Partial Update)</h5>
            </div>
            <div class="card-body">
                <form id="patchClassForm">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="roomType">
                    </div>
                    <div class="mb-3">
                    ...
                    <p class="text-muted">Note: Only fill the fields you want to update</p>
    ...
    <?php include 'modals/patchexamplemodal.php'; ?>

    <script>
        $(document).ready(function() {
            $('#patchClassForm').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        Room_Type: $('#roomType').val() || null,
                        Section: $('#section').val() || null,
                        Teacher_ID: $('#teacherId').val() || null
                    }),
