        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">PATCH API Documentation</h5>
                ...
                <div class="modal-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Partial update of a class</td>
                                    <td>Capacity, Room_Type, Section, Teacher_ID</td>
                                </tr>
                                <tr>
                                    <td><code>updateGrade</code></td>
                                    <td>Partial update of a grade</td>
                                    <td>Student_LRN, Advisory, Subject, Quarter1-4, school_year</td>
                                </tr>
                                <tr>
                                    <td><code>updateGradeLevel</code></td>
                                    <td>Partial update of grade level</td>
                                    <td>Grade_Level, Grade 1-6</td>
                                </tr>
                                <tr>
                                    <td><code>updateInventory</code></td>
                                    <td>Partial update of inventory item</td>
                                    <td>Any inventory fields</td>
                                </tr>
                                <tr>
                                    <td><code>updateStudent</code></td>
                                    <td>Partial update of student</td>
                                    <td>Any student fields</td>
                                </tr>
                                <tr>
                                    <td><code>updateSubject</code></td>
                                    <td>Partial update of subject</td>
                                    <td>Any subject fields</td>
                                </tr>
                                <tr>
                                    <td><code>updateTeacher</code></td>
                                    <td>Partial update of teacher</td>
                                    <td>Any teacher fields</td>
                                </tr>
                                <tr>
                                    <td><code>updateTeacherFile</code></td>
                                    <td>Partial update of teacher file</td>
                                    <td>Any file fields</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <ul>
                        <li>PATCH allows partial updates (only send fields you want to change)</li>
                        <li>The ID of the record to update must be provided in the URL</li>
                        <li>Only provided fields will be updated</li>
                        <li>For full updates, use PUT instead</li>
                    </ul>
...
<pre><code>PATCH http://localhost/PhpAPI/api.php?request=updateClass&id=123&token=your_token
...
&lt;form id=<span style="color: #ce9178">"patchClassForm"</span>&gt;
    ...
    &lt;div class=<span style="color: #ce9178">"mb-3"</span>&gt;
        ...
        &lt;input type=<span style="color: #ce9178">"number"</span> class=<span style="color: #ce9178">"form-control"</span> id=<span style="color: #ce9178">"capacity"</span>&gt;
    &lt;/div&gt;
    &lt;div class=<span style="color: #ce9178">"mb-3"</span>&gt;
        &lt;label for=<span style="color: #ce9178">"roomType"</span> class=<span style="color: #ce9178">"form-label"</span>&gt;Room Type:&lt;/label&gt;
        &lt;input type=<span style="color: #ce9178">"text"</span> class=<span style="color: #ce9178">"form-control"</span> id=<span style="color: #ce9178">"roomType"</span>&gt;
    &lt;/div&gt;
    &lt;div class=<span style="color: #ce9178">"mb-3"</span>&gt;
        &lt;label for=<span style="color: #ce9178">"section"</span> class=<span style="color: #ce9178">"form-label"</span>&gt;Section:&lt;/label&gt;
        &lt;input type=<span style="color: #ce9178">"text"</span> class=<span style="color: #ce9178">"form-control"</span> id=<span style="color: #ce9178">"section"</span>&gt;
    &lt;/div&gt;
    &lt;div class=<span style="color: #ce9178">"mb-3"</span>&gt;
        &lt;label for=<span style="color: #ce9178">"teacherId"</span> class=<span style="color: #ce9178">"form-label"</span>&gt;Teacher ID:&lt;/label&gt;
        &lt;input type=<span style="color: #ce9178">"number"</span> class=<span style="color: #ce9178">"form-control"</span> id=<span style="color: #ce9178">"teacherId"</span>&gt;
    &lt;/div&gt;
    &lt;button type=<span style="color: #ce9178">"submit"</span> class=<span style="color: #ce9178">"btn btn-warning"</span>&gt;Update Class&lt;/button&gt;
&lt;/form&gt;</code></pre>
</div>
...
<div class="bg-dark p-3 rounded">
    ...
    <span style="color: #569cd6">$</span>(<span style="color: #dcdcaa">document</span>).<span style="color: #dcdcaa">ready</span>(<span style="color: #569cd6">function</span>() {
            <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#patchClassForm'</span>).<span style="color: #dcdcaa">on</span>(<span style="color: #ce9178">'submit'</span>, <span style="color: #569cd6">function</span>(<span style="color: #9cdcfe">e</span>) {
                ...
                <span style="color: #569cd6">$</span>.<span style="color: #dcdcaa">ajax</span>({
                    ...
                    <span style="color: #9cdcfe">method</span>: <span style="color: #ce9178">'PATCH'</span>,
                    ...
                    <span style="color: #9cdcfe">data</span>: <span style="color: #4ec9b0">JSON</span>.<span style="color: #dcdcaa">stringify</span>({
                        <span style="color: #9cdcfe">Capacity</span>: <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#capacity'</span>).<span style="color: #dcdcaa">val</span>() || <span style="color: #569cd6">null</span>,
                        <span style="color: #9cdcfe">Room_Type</span>: <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#roomType'</span>).<span style="color: #dcdcaa">val</span>() || <span style="color: #569cd6">null</span>,
                        <span style="color: #9cdcfe">Section</span>: <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#section'</span>).<span style="color: #dcdcaa">val</span>() || <span style="color: #569cd6">null</span>,
                        <span style="color: #9cdcfe">Teacher_ID</span>: <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#teacherId'</span>).<span style="color: #dcdcaa">val</span>() || <span style="color: #569cd6">null</span>
                    }),
                    <span style="color: #9cdcfe">success</span>: <span style="color: #569cd6">function</span>(<span style="color: #9cdcfe">response</span>) {
                        ...
                        <span style="color: #c586c0">if</span> (<span style="color: #9cdcfe">response</span>.<span style="color: #9cdcfe">status</span> === <span style="color: #ce9178">'success'</span>) {
                            ...
                            <span style="color: #569cd6">$</span>(<span style="color: #ce9178">'#patchClassForm'</span>)[<span style="color: #b5cea8">0</span>].<span style="color: #dcdcaa">reset</span>();
